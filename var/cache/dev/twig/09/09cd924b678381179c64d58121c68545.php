...
class __TwigTemplate_21ad0ec5c1568541434d02c2340e2234 extends Template
{
...
";
            ...
            foreach ($context['_seq'] as $context["flag_code"] => $context["country_name"]) {
                ...
                yield "        <span>";
                // line 20
                if ((($tmp = (isset($context["show_flag"]) || array_key_exists("show_flag", $context) ? $context["show_flag"] : (function () { throw new RuntimeError('Variable "show_flag" does not exist.', 20, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 21
                    if ((($tmp =  !(null === $context["flag_code"])) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 22
                        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("ea:Flag", ["countryCode" => $context["flag_code"], "height" => "17"]);
                ...
                // line 26
                if ((($tmp = (isset($context["show_name"]) || array_key_exists("show_name", $context) ? $context["show_name"] : (function () { throw new RuntimeError('Variable "show_name" does not exist.', 26, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 27
...
{% else %}
    ...
    {% endfor %}
{% endif %}
", "@EasyAdmin/crud/field/country.html.twig", "C:\\xampp\\htdocs\\gestalt_site\\vendor\\easycorp\\easyadmin-bundle\\templates\\crud\\field\\country.html.twig");
    }
}
