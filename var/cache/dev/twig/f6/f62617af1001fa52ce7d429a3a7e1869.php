...
class __TwigTemplate_0bd5996281e26779912a54f8f925d994 extends Template
{
    ...
    {
        // line 1
        return $this->load((isset($context["layout_template_path"]) || array_key_exists("layout_template_path", $context) ? $context["layout_template_path"] : (function () { throw new RuntimeError('Variable "layout_template_path" does not exist.', 1, $this->source); })()), 1);
    }
...
";
    ...
    {
        return array (  147 => 11,  141 => 10,  138 => 9,  128 => 8,  111 => 7,  94 => 6,  77 => 4,  60 => 3,  44 => 1,);
    }
...
{% block main %}
    <div class=\"error-message\">
        <h1>{{ component('ea:Icon', { name: 'internal:circle-exclamation' }) }} {{ block('page_title') }}</h1>
        {{ exception.publicMessage|trans(exception.translationParameters, 'EasyAdminBundle') }}
    </div>
{% endblock %}
", "@EasyAdmin/exception.html.twig", "C:\\xampp\\htdocs\\gestalt_site\\vendor\\easycorp\\easyadmin-bundle\\templates\\exception.html.twig");
    }
}
