...
class getSecurity_Logout_Listener_Default_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Security\Http\EventListener\DefaultLogoutListener($a, '/');

        if (isset($container->privates['security.logout.listener.default.main'])) {
            return $container->privates['security.logout.listener.default.main'];
        }

        return $container->privates['security.logout.listener.default.main'] = $instance;
    }
}
