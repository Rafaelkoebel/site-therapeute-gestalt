 ...
 */
class getMotifConsultationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MotifConsultationRepository' shared autowired service.
     *
     * @return \App\Repository\MotifConsultationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MotifConsultationRepository.php';

        return $container->privates['App\\Repository\\MotifConsultationRepository'] = new \App\Repository\MotifConsultationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
