 ...
 */
class getMessageContactRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessageContactRepository' shared autowired service.
     *
     * @return \App\Repository\MessageContactRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageContactRepository.php';

        return $container->privates['App\\Repository\\MessageContactRepository'] = new \App\Repository\MessageContactRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
