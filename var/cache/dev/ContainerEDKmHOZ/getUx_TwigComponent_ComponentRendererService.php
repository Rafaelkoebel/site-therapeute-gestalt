...
class getUx_TwigComponent_ComponentRendererService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\TwigComponent\ComponentRenderer($a, $b, $c, ($container->privates['ux.twig_component.component_properties'] ?? $container->load('getUx_TwigComponent_ComponentPropertiesService')), new \Symfony\UX\TwigComponent\ComponentStack());

        if (isset($container->privates['ux.twig_component.component_renderer'])) {
            return $container->privates['ux.twig_component.component_renderer'];
        }

        return $container->privates['ux.twig_component.component_renderer'] = $instance;
    }
}
