 ...
 */
class getTherapeuteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TherapeuteRepository' shared autowired service.
     *
     * @return \App\Repository\TherapeuteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TherapeuteRepository.php';

        return $container->privates['App\\Repository\\TherapeuteRepository'] = new \App\Repository\TherapeuteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
