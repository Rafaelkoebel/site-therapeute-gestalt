 ...
 */
class getPageRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PageRepository.php';

        return $container->privates['App\\Repository\\PageRepository'] = new \App\Repository\PageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
