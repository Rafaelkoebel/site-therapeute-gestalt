...
class getAdminDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'AdminDashboardController.php';

        $instance = new \App\Controller\Admin\AdminDashboardController(($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));

        if (isset($container->services['App\\Controller\\Admin\\AdminDashboardController'])) {
            return $container->services['App\\Controller\\Admin\\AdminDashboardController'];
        }

        $container->services['App\\Controller\\Admin\\AdminDashboardController'] = $instance;
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'twig' => '?',
        ]))->withContext('App\\Controller\\Admin\\AdminDashboardController', $container));
