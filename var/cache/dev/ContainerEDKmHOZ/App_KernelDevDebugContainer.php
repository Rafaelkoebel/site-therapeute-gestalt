...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\InfoPratiqueCrudController' => 'getInfoPratiqueCrudControllerService',
            'App\\Controller\\Admin\\MessageContactCrudController' => 'getMessageContactCrudControllerService',
            'App\\Controller\\Admin\\MotifConsultationCrudController' => 'getMotifConsultationCrudControllerService',
            'App\\Controller\\Admin\\PageCrudController' => 'getPageCrudControllerService',
            'App\\Controller\\Admin\\TherapeuteCrudController' => 'getTherapeuteCrudControllerService',
            'App\\Controller\\ContactController' => 'getContactControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\InfoPratiqueController' => 'getInfoPratiqueControllerService',
    ...
    {
        return $container->services['cache.easyadmin'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mTt0-Ss0f4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getAdminRouterSubscriberService($container)
    {
        ...
        $e = ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\EntityFactory'] ?? self::getEntityFactoryService($container));

        if (isset($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'])) {
            return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'];
        }
        $f = ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\ActionFactory'] ?? self::getActionFactoryService($container));

        if (isset($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'])) {
            return $container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\EventListener\\AdminRouterSubscriber'];
        }
        $g = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry(['App\\Controller\\Admin\\InfoPratiqueCrudController' => 'App\\Entity\\InfoPratique', 'App\\Controller\\Admin\\MessageContactCrudController' => 'App\\Entity\\MessageContact', 'App\\Controller\\Admin\\MotifConsultationCrudController' => 'App\\Entity\\MotifConsultation', 'App\\Controller\\Admin\\PageCrudController' => 'App\\Entity\\Page', 'App\\Controller\\Admin\\TherapeuteCrudController' => 'App\\Entity\\Therapeute'], ['App\\Controller\\Admin\\InfoPratiqueCrudController' => '675d6d9', 'App\\Controller\\Admin\\MessageContactCrudController' => 'ecf68d0', 'App\\Controller\\Admin\\MotifConsultationCrudController' => '5acc8be', 'App\\Controller\\Admin\\PageCrudController' => 'd27103d', 'App\\Controller\\Admin\\TherapeuteCrudController' => '6d5168a'], ['App\\Entity\\InfoPratique' => 'App\\Controller\\Admin\\InfoPratiqueCrudController', 'App\\Entity\\MessageContact' => 'App\\Controller\\Admin\\MessageContactCrudController', 'App\\Entity\\MotifConsultation' => 'App\\Controller\\Admin\\MotifConsultationCrudController', 'App\\Entity\\Page' => 'App\\Controller\\Admin\\PageCrudController', 'App\\Entity\\Therapeute' => 'App\\Controller\\Admin\\TherapeuteCrudController'], ['675d6d9' => 'App\\Controller\\Admin\\InfoPratiqueCrudController', 'ecf68d0' => 'App\\Controller\\Admin\\MessageContactCrudController', '5acc8be' => 'App\\Controller\\Admin\\MotifConsultationCrudController', 'd27103d' => 'App\\Controller\\Admin\\PageCrudController', '6d5168a' => 'App\\Controller\\Admin\\TherapeuteCrudController']);

        $instance = new \EasyCorp\Bundle\EasyAdminBundle\EventListener\AdminRouterSubscriber(new \EasyCorp\Bundle\EasyAdminBundle\Factory\AdminContextFactory($container->targetDir.'', ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Factory\MenuFactory(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $a, $b, (isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), new \EasyCorp\Bundle\EasyAdminBundle\Menu\MenuItemMatcher((isset($container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']) ? $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator']($container) : self::getAdminUrlGeneratorService($container)), $c), $d), $g, $e, $c, $f), ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Factory\\ControllerFactory'] ?? self::getControllerFactoryService($container)), ($container->privates['debug.controller_resolver'] ?? self::getDebug_ControllerResolverService($container)), $d, $d, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), $c, $container->targetDir.'', $g);
    ...
    protected static function getAdminRouteGeneratorService($container)
    {
        $instance = new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminRouteGenerator(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['App\\Controller\\Admin\\AdminDashboardController'] ?? $container->load('getAdminDashboardControllerService'));
        }, 1), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['App\\Controller\\Admin\\InfoPratiqueCrudController'] ?? $container->load('getInfoPratiqueCrudControllerService'));
            yield 1 => ($container->services['App\\Controller\\Admin\\MessageContactCrudController'] ?? $container->load('getMessageContactCrudControllerService'));
            yield 2 => ($container->services['App\\Controller\\Admin\\MotifConsultationCrudController'] ?? $container->load('getMotifConsultationCrudControllerService'));
            yield 3 => ($container->services['App\\Controller\\Admin\\PageCrudController'] ?? $container->load('getPageCrudControllerService'));
            yield 4 => ($container->services['App\\Controller\\Admin\\TherapeuteCrudController'] ?? $container->load('getTherapeuteCrudControllerService'));
        }, 5), ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)), ($container->privates['filesystem'] ??= new \Symfony\Component\Filesystem\Filesystem()), $container->targetDir.'', 'en', new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    ...
    protected static function getAdminUrlGeneratorService($container)
    {
        $container->factories['service_container']['EasyCorp\\Bundle\\EasyAdminBundle\\Router\\AdminUrlGenerator'] = function ($container) {
            ...
            return new \EasyCorp\Bundle\EasyAdminBundle\Router\AdminUrlGenerator(($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Provider\\AdminContextProvider'] ?? self::getAdminContextProviderService($container)), $a, ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\DashboardControllerRegistry'] ??= new \EasyCorp\Bundle\EasyAdminBundle\Registry\DashboardControllerRegistry($container->targetDir.'', ['App\\Controller\\Admin\\AdminDashboardController' => 'd8cbba3'], ['d8cbba3' => 'App\\Controller\\Admin\\AdminDashboardController'])), $b, ($container->services['cache.easyadmin'] ?? self::getCache_EasyadminService($container)));
        };
    ...
    protected static function getDebug_ControllerResolverService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\AdminDashboardController', 'App\\Controller\\Admin\\InfoPratiqueCrudController', 'App\\Controller\\Admin\\MessageContactCrudController', 'App\\Controller\\Admin\\MotifConsultationCrudController', 'App\\Controller\\Admin\\PageCrudController', 'App\\Controller\\Admin\\TherapeuteCrudController', 'App\\Controller\\ContactController', 'App\\Controller\\HomeController', 'App\\Controller\\InfoPratiqueController', 'App\\Controller\\MenuController', 'App\\Controller\\PageController', 'App\\Controller\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
