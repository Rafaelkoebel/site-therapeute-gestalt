...
class getUx_TwigComponent_Twig_ComponentRuntimeService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\UX\TwigComponent\Twig\ComponentRuntime($a, ($container->privates['.service_locator.Xbsa8iG'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])));

        if (isset($container->privates['ux.twig_component.twig.component_runtime'])) {
            return $container->privates['ux.twig_component.twig.component_runtime'];
        }

        return $container->privates['ux.twig_component.twig.component_runtime'] = $instance;
    }
}
